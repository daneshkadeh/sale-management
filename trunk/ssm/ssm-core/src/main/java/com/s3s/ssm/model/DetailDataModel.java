...
public class DetailDataModel {
	public enum FieldTypeEnum {
		TEXTBOX, RICH_TEXTBOX, DROPDOWN, MULTI_SELECT_BOX, PASSWORD, CHECKBOX, DATE, RADIO_BUTTON, IMAGE, FILE_CHOOSER;
	}
	...
	/**
	 * Tab data structure store info of the tabs. Including the index of
	 * <code>detailAttributes</code> to start tab and corresponding name of tab.
	 */
