...
public class GridBagLayoutBuilder implements LayoutBuilder {
    ...
    public ComponentFactory getComponentFactory() {
        ...
        // }
        return (ComponentFactory) componentFactory;
    }
     ...
     * 
     * @param label
     *            the label to associate and layout with the field
     * @param colSpan
     *            the number of columns the field should span
     * 
     * @return "this" to make it easier to string together append calls
    ...
    /**
     * Appends a right-justified label to the end of the given line, using the provided string as the key to look in the
     * {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text to use.
     * 
     * @param labelKey
     *            the key into the message bundle; if not found the key is used as the text to display
     * 
     * @return "this" to make it easier to string together append calls
     */
    ...
    /**
     * Appends a left-justified label to the end of the given line, using the provided string as the key to look in the
     * {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text to use.
     * 
     * @param labelKey
     *            the key into the message bundle; if not found the key is used as the text to display
    ...
    /**
     * Appends the given component to the end of the current line. The component will "grow" horizontally as space
     * allows.
     * 
     * @param component
     *            the item to append
    ...
    /**
     * Appends a seperator (usually a horizonal line). Has an implicit {@link #nextLine()}before and after it.
     * 
     * @return "this" to make it easier to string together append calls
     */
    ...
    /**
     * Appends a seperator (usually a horizonal line) using the provided string as the key to look in the
     * {@link #setComponentFactory(ComponentFactory) ComponentFactory's}message bundle for the text to put along with
     * the seperator. Has an implicit {@link #nextLine()}before and after it.
     * 
     * @return "this" to make it easier to string together append calls
     */
    public GridBagLayoutBuilder appendSeparator(String labelKey) {
        ...
        final JComponent separator = null;
    ...
    /**
     * Should the last column before a {@link #nextLine()}automaticly span to the end of the panel?
     * <p />
     * 
