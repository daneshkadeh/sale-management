...
/**
 * The component multi-selection box. This component includes the source list
 * box, the destination list box and 4 buttons to move elements between these 2
 * list boxes. </br> The useful methods:
 * <ul>
...
public class MultiSelectionBox<T> extends JPanel {
	...
	/**
	 * Initialize multiselectbox with the source values and the destination
	 * values. And renderer of 2 list box is {@link DefaultListCellRenderer}.
	 * 
	 * @param sources
	 * @param destinations
	 */
	...
	/**
	 * Initialize multiselectbox with the source values and the destination
	 * values, and the renderer of 2 list box.
	 * 
	 * @param sources
	 * @param destinations
	 * @param cellRenderer
	...
	private void initComponents() {
		setLayout(new MigLayout("gap 10",
				"[48%, grow,fill][center][48%,grow,fill]", "[grow,center]"));
	 ...
	 * @param to
	 * @param allElements
	 *            move all elements if <code>true</code>, else just move the
	 *            selected value of <code>from</code> JList.
	 */
