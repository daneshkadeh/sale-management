package com.s3s.ssm.security.permission;
...
public class ActionsPermission extends Permission {
    ...
    @Override
    public int hashCode() {
        return getClass().getName().hashCode() * 19 + getName().hashCode() * 19 + getActions().hashCode() * 19;
    }
