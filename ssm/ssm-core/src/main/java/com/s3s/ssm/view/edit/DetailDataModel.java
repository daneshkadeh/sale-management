...
public class DetailDataModel {
    public enum DetailFieldType {
        LABEL, TEXTBOX, TEXTAREA, DROPDOWN, DROPDOWN_AUTOCOMPLETE, MULTI_SELECT_LIST_BOX, MULTI_SELECT_TREE_BOX, PASSWORD, CHECKBOX, DATE, RADIO_BUTTON_GROUP, IMAGE, MONEY, FILE_CHOOSER, SEARCHER, SALE_TARGET, ENTITY_CHOOSER, LIST,
        /**
         * @deprecated using YEAR_MON_DAY or HOUR_MIN_SEC instead
         */
        TIME_COMPONENT, YEAR_MON_DAY, HOUR_MIN_SEC;
    }
