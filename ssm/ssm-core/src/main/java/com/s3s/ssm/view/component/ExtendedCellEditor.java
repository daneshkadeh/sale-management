...
/**
 * Copy all code from DefaultCellEditor to extend more component.
 * 
 * @author phamcongbang
 * 
 */
public class ExtendedCellEditor extends AbstractCellEditor implements TableCellEditor, TreeCellEditor {
    ...
    public ExtendedCellEditor(final MoneyComponent moneyComponent) {
        editorComponent = moneyComponent;
        this.clickCountToStart = 2;
        delegate = new EditorDelegate() {
            public void setValue(Object value) {
                moneyComponent.setMoney((value != null) ? (Money) value : null);
            }
        ...
        moneyComponent.addActionListener(delegate);
        moneyComponent.setRequestFocusEnabled(false);
    }
        ...
        delegate = new EditorDelegate() {
            ...
            public boolean stopCellEditing() {
                if (comboBox.isEditable()) {
                    // Commit edited value.
                    comboBox.actionPerformed(new ActionEvent(ExtendedCellEditor.this, 0, ""));
                }
    ...
    protected class EditorDelegate implements ActionListener, ItemListener, Serializable {
        ...
        public void actionPerformed(ActionEvent e) {
            ExtendedCellEditor.this.stopCellEditing();
        }
