...
public class ListInventoryDetailComponent extends AListComponent<DetailInventoryStore> {
    ...
    protected void initialPresentationView(ListDataModel listDataModel) {
        ...
        listDataModel.addColumn("curQty", ListRendererType.NUMBER).width(UIConstants.QTY_COLUMN_WIDTH).summarized();
        listDataModel.addColumn("curPriceSubtotal", ListRendererType.NUMBER).width(UIConstants.AMT_COLUMN_WIDTH)
                .summarized();
        listDataModel.addColumn("realQty", ListRendererType.NUMBER).width(UIConstants.QTY_COLUMN_WIDTH).summarized();
        listDataModel.addColumn("realPriceSubtotal", ListRendererType.NUMBER).width(UIConstants.AMT_COLUMN_WIDTH)
                .summarized();
        listDataModel.addColumn("lostQty", ListRendererType.NUMBER).width(UIConstants.QTY_COLUMN_WIDTH).summarized();
     ...
     */
    @Override
    protected DetailInventoryStore createNewEntity() {
