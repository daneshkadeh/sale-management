 ...
 * 
 */
public class ListCustEncouragementStatistic extends AListDataView<CustEncouragementDTO> {
    ...
    protected void initialPresentationView(ListDataModel listDataModel) {
        ...
        listDataModel.addColumn("paidAmt", ListRendererType.TEXT);
        listDataModel.addColumn("remainingAmt", ListRendererType.TEXT);
    }

    @Override
    protected List<CustEncouragementDTO> loadData(int fistIndex, int maxResults) {
        Partner selCustomer = (Partner) cbCustomer.getSelectedItem();
        if (selCustomer == null) {
            return Collections.EMPTY_LIST;
        }
        return serviceProvider.getService(IContactService.class).statisticCustEncouragement(selCustomer);
    }
    ...
    protected JPanel createSearchPanel() {
        ...
        panel.add(new JLabel(ControlConfigUtils.getString("label.CustEncouragementDTO.customer")), "left");
